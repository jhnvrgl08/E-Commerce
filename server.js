...
// firebase admin setup
 serviceAccount = require("./ecom-website-395a0-firebase-adminsdk-wh2m3-a4abab71bb.json");
...
const bucketName = "ecom-website-tutorials-3";
...
app.post('/signup', (req, res) => {
  ...
  .then(user => {
    if(user.exists){
      ...
      // enrypt the password before storing it.
...
app.post('/add-product', (req, res) => {
  ...
  .catch(err => {
      return res.json({'alert': 'some erroor occured. Try again'});
  })
})
...
app.post('/order', (req, res) => {
  ...
  const mailOption = {
    from: 'johnquinones350@gmail.com',
    to: email, 
